...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SYM] = LAYOUT_split_3x5_3(
        ...
        KC_HASH, KC_AMPR, KC_PLUS, KC_ASTR, KC_EQL,  KC_UNDS, CM_LSFT, CM_LCTL, TD_ALT,  CM_LGUI,
        XXXXXXX, KC_PIPE, KC_MINS, KC_SLSH, KC_PERC, KC_AT,   KC_BSLS, KC_EXLM, KC_QUES, XXXXXXX,
                          _______, _______, _______, _______, _______, _______
    ),

    [NAV] = LAYOUT_split_3x5_3(
        KC_ESC,  XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, KC_DEL,  KC_HOME, KC_UP,   KC_END,  XXXXXXX,
        CM_LGUI, TD_ALT,  CM_LCTL, CM_LSFT, XXXXXXX, KC_BSPC, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX,
        AU_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_INS,  KC_PGUP, XXXXXXX, KC_PGDN, XXXXXXX,
                          _______, _______, _______, _______, _______, _______
    ),

    [NUM] = LAYOUT_split_3x5_3(
        KC_9,    KC_7,    KC_5,    KC_3,    KC_1,    KC_0,    KC_2,    KC_4,    KC_6,    KC_8,
        CM_LGUI, TD_ALT,  CM_LCTL, CM_LSFT, KC_F11,  KC_F12,  CM_LSFT, CM_LCTL, TD_ALT,  CM_LGUI,
